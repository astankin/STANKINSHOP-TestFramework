    ...
    def test_register_user_with_email_without_at_symbol(self, setup):
        ...
        try:
            ...
            assert self.driver.current_url == self.register_page.url, \
                f"Expected to be on {self.register_page.url}, but got {self.driver.current_url}"
        except NoSuchElementException as e:
            pytest.fail(f"Email error message not found. Expected message: {expected_message}. Error: {str(e)}")
